...
func Init(cfg config.Config) error {
	...
	dirs := []string{
		...
		filepath.Join(cfg.App.Workspace, "memory", "logs"),
		filepath.Join(cfg.App.Workspace, "memory", "schedules"),
		filepath.Join(cfg.App.Workspace, "memory", "schedules", "runs"),
		filepath.Join(cfg.App.Workspace, "memory", "eino_checkpoints"),
		filepath.Join(cfg.App.Workspace, "memory", "tool_payloads"),
		filepath.Join(cfg.App.Workspace, "memory", "tool_payloads", "clear"),
		filepath.Join(cfg.App.Workspace, "memory", "tool_payloads", "trunc"),
		filepath.Join(cfg.App.Workspace, "memory", "learning"),
		filepath.Join(cfg.App.Workspace, "memory", "learning", "proposals"),
		filepath.Join(cfg.App.Workspace, "memory", "learning", "reports"),
